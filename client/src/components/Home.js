...
export default function Home(props) {
  ...
  return (
    <div className="lg:mt-10 mt-0 py-6 lg:py-0">
      <div className="lg:m-auto lg:ml-auto ml-4  lg:w-3/4 p-5 mx-8 rounded-md  lg:mt-8 bg-violet-400 text-black">
      ...
      <div className="bg-white rounded-md lg:p-5 p-3  lg:m-auto lg:mt-4 mt-4 lg:w-3/4 mx-6 ml-3  cursor-pointer">
        <DoughnutChart chartData={expenseData} />
      </div>
      <Link to="dailyspendanalysis">
        <div className="w-3/4 m-auto p-4 mt-7 rounded-md bg-violet-400 hover:bg-violet-200 text-black lg:block hidden">
          <h1 className="flex text-2xl w-fit m-auto">
            <span className="mr-3 text-[#1a1463]">
              <svg
