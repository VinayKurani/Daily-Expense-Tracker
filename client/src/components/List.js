...
export default function List(props) {
  ...
  return (
    <div className="m-2 mt-4 lg:mt-0 mx-4 lg:mx-0 p-2  lg:grid lg:grid-cols-7  text-black bg-violet-400 rounded-xl lg:p-4 lg:m-6 lg:w-[90%] w-[65%] flex">
      <div
        onClick={HandleSetUp}
        className="text-[#902bf5] absolute cursor-pointer"
      >
        <svg
      ...
      <div className="bg-gray-200 rounded-full lg:w-2/3 w-fit  h-12 relative top-3 p-2 mb-8 lg:mb-3">
        <img src={Money} className="h-7 w-7 mt-1"></img>
      </div>
      <div className="lg:col-span-4 ml-3 lg:ml-0 mt-2 lg:mt-2 ">
        <div className="flex">
          <div className="flex text-[#1a1463] bg-white rounded-xl w-fit px-2 py-1 ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
              viewBox="0 0 20 20"
          ...
          <div className="flex text-[#1a1463] bg-white rounded-xl w-fit px-2 py-1 ml-3 ">
