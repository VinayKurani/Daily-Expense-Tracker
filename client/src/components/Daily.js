...
export default function Daily() {
  ...
  return (
    <div className="pt-2 lg:pt-0 pb-10 lg:pb-0 ">
      <div className="bg-violet-400 lg:w-3/4 w-[86%] p-5 flex lg:m-auto ml-5 lg:mt-28  rounded-md justify-center">
      ...
      <div className="lg:w-3/4 w-[86%] mx-5 lg:mt-3 mt-4 p-5 lg:m-auto bg-white rounded-lg ">
        {haveSpent ? (
