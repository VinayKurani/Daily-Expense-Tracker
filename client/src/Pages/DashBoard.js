    ...
    <div>
      <div className="lg:grid lg:grid-cols-5 h-screen font-lexend overflow-y-scroll overflow-x-clip">
        <div className="col-span-1 p-4 bg-white text-[#fc7b54]">
          <div className="lg:inline flex">
            ...
            <ul className="lg:flex lg:flex-col mt-10 hidden">
              <Link to="/dashboard">
                <li
                  ...
                  className={
                    active === "1"
                      ? "mb-4 flex px-5 py-3 cursor-pointer text-2xl hover:bg-violet-50 hover:rounded-md bg-violet-50 rounded-md"
                      : "mb-4 flex px-5 py-3 cursor-pointer text-2xl hover:bg-violet-50 hover:rounded-md transition delay-100"
                  }
                >
                  <span className="mr-3">
                    <svg
            ...
            <div className="lg:hidden flex">
              <button
                className="ml-32 bg-[#fc7b54] rounded-lg "
        ...
        <div
          ...
          className={isMobile ? "hidden bg-white" : "inline bg-white"}
        >
            ...
            <ul className="">
              ...
              <Link to="/dashboard">
                <li
                  ...
                  className={
                    active === "1"
                      ? "text-[#fc7b54] flex text-2xl p-2 pt-8"
                      : "text-[#fc7b54]  w-fit  flex text-2xl  pt-8"
                  }
                >
                  <span className="mx-4">
                    <svg
              ...
              <Link to="/dashboard/analysis">
                <li
                  ...
                  className={
                    active === "2"
                      ? "text-[#fc7b54] flex text-2xl p-2 pt-4"
                      : "text-[#fc7b54] flex text-2xl p-2 pt-4"
                  }
                >
                  <span className="mx-4">
              ...
              <div className="ml-6  mt-4 bottom-5 left-16 pb-6 ">
                <button
                  ...
                  className="bg-[#fc7b54] px-4 py-3 flex rounded-md font-bold duration-300 ease-out hover:scale-110"
                >
                  <span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
