...
export default function ConfirmDelete(props) {
  ...
  return (
    <div className="font-lexand">
      <div>
        <div>
          <h1 className="text-black font-bold text-xl w-fit ml-10">
            Are you sure ?
          </h1>
        </div>
        <div className="mt-4 w-fit ml-auto text-black flex">
          ...
          <button
            ...
            className="py-2 px-4 rounded-md hover:scale-110 duration-150 ease-out font-bold font-lexand bg-[#fc7b54]"
          >
            No
          </button>
        </div>
